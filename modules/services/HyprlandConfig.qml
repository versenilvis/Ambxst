...
QtObject {
    ...
    function applyHyprlandConfigInternal() {
        ...
        if (isLuaParser) {
            ...
            // disable animation for ambxst windows to open instantly at 0ms
            luaCode.push(`hl.window_rule({ match = { class = "^(org.quickshell)$" }, no_anim = true })`);
            ...
            batchCommand += ` ; keyword layerrule noanim,quickshell ; keyword layerrule blur,quickshell ; keyword layerrule blurpopups,quickshell ; keyword layerrule ignorealpha ${ignoreAlphaValue},quickshell ; keyword windowrulev2 noanim,class:^(org.quickshell)$`;
